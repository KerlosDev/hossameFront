...
const Offer = () => {
    ...
    return (
        <div dir="rtl" className="min-h-[60vh] font-arabicUI2 py-6 px-4 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                {/* Header */}
                <div className="text-center mb-8 sm:mb-16" dir="rtl">
                    <div className="inline-flex items-center gap-2 sm:gap-4 px-4 sm:px-8 py-2 sm:py-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-xl rounded-2xl
                        ...
                        <FiZap className="text-3xl sm:text-4xl text-red-500" />
                    </div>
                ...
                {/* Main Offer Card */}
                <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden 
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute top-6 left-6 z-10" dir="rtl">
                            <div className="relative">
                        ...
                        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-8">
                            ...
                            <div className="order-2 lg:order-1" dir="rtl">
                                ...
                                <div className="mb-8">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 
                                                      rounded-3xl blur-2xl opacity-30 scale-110"></div>
                                        ...
                                        <div className="relative bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500 
                                            ...
                                            <div className="relative z-10 text-center">
                                                ...
                                                <div className="inline-flex items-center gap-2 px-6 py-2 bg-white/20 backdrop-blur-md 
                                                ...
                                                <div className="flex items-center justify-center gap-4 mt-4">
                                                    ...
                                                    <div className="relative w-12 h-12 bg-white/20 backdrop-blur-md 
                                                ...
                                                <div className="mt-6 px-6 py-3 bg-white/15 backdrop-blur-md rounded-2xl 
                                            ...
                                            <div className="absolute top-4 right-4 w-4 h-4 bg-white/50 rounded-full" />
                                            <div className="absolute bottom-4 left-4 w-4 h-4 bg-white/50 rounded-full" />

                                            {/* Progress indicator similar to countdown seconds */}
                                            <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 w-32 h-1 
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-6 text-lg leading-relaxed font-arabicUI3">
                                    {offer.description}
                                </p>
                                    ...
                                    <div className="text-center mb-6">
                                        ...
                                        <div className="relative max-w-3xl mx-auto">
                                            ...
                                            <div className="relative bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl 
                                                        ...
                                                        return (
                                                            <div key={unit} className="relative group">
                                                                ...
                                                                <div className="relative perspective-1000">
                                                                    {/* Outer glow ring */}
                                                                    <div className="absolute -inset-2 rounded-2xl opacity-75"
                                                                        style={{
                                                ...
                                                {/* Progress bar */}
                                                <div className="mt-8 relative h-2 bg-gray-200/50 dark:bg-gray-700/50 rounded-full overflow-hidden">
                                                    <div className="absolute inset-0 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                                                ...
                                                <div className="relative group">
                                                    <div className="relative bg-gradient-to-br from-green-400 to-emerald-600 
                                                        ...
                                                        <div className="text-center relative z-10">
                                                            <div className="text-sm text-white/90 mb-2 font-arabicUI3 flex items-center justify-center gap-1">
                                                                <span>⭐</span>
                                                                السعر الخاص
                                                                <span>⭐</span>
                                                            </div>
                                                            <div className="text-5xl font-black text-white drop-shadow-lg mb-1">
                                                                ${offer.discountPrice}
                                                            </div>
